...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_ACCESS_bank_address_less_than_0x80(){
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_ACCESS_bank_address_less_than_0x80(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_ACCESS_bank_address_more_than_0x80(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_ACCESS_bank_address_more_than_0x80(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_default_op3_bank_address_less_than_0x80(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_GPR_bank(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_GPR_bank(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_ACCESS_bank_address_less_than_0x80_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_ACCESS_bank_address_less_than_0x80_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_ACCESS_bank_address_more_than_0x80_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_ACCESS_bank_address_more_than_0x80_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_GPR_bank_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_1_if_not_skip_for_GPR_bank_and_store_in_WREG(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_ACCESS_bank_if_operand1_is_0x350(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
...
void test_incfsz_should_return_absAddress_plus_2_if_skip_for_GPR_bank_if_operand1_is_0x550(){
	CEXCEPTION_T catchError;
	int result;
	//Test fixture
	Bytecode code = {.instruction = {.mnemonic = INCFSZ, .name = "incfsz"},
